...
Original file is located at
    https://colab.research.google.com/drive/1zZES5O47ulT25CD7EUYwAJydAnCofQrb
"""
...
#we can se that there are several missing values in the dataset
df.fillna(df.mean(),inplace=True)  ##filing the values with mean values
...
#Visualize box plots after managing outliers
plt.figure(figsize=(10, 6))
sns.boxplot(data=df)
plt.title('Boxplot of Wine Dataset (After Managing Outliers)')
plt.xticks(rotation=45)
plt.show()
...
#Define a function to map quality to categories
...
#Apply the function to transform the target variable
...
#label encoding the category data
...
#selection of relevant features for predicting wine quality
